...
$(document).ready(function() {
    ...
    $('.fb').on('click', function() {
        url = 'https://www.facebook.com/dialog/feed?app_id=301375193309601&redirect_uri=' + encodeURIComponent(document.location.href) + '&link=' + encodeURIComponent('http://danesjenovdan.si/borut/') + '&ref=responsive&name=' + encodeURIComponent('Et tu Borute')
        window.open(url, '_blank');
        ga('send', 'event', 'social', 'facebook');
        return false;
    });
    $('.tw').on('click', function() {
        url = 'https://twitter.com/intent/tweet?text=' + encodeURIComponent('Obeleži umor svobodne KPK in si nastavi e-opomnik za predsedniške volitve 2017! http://djnd.si/cf');
        window.open(url, '_blank');
        ga('send', 'event', 'social', 'twitter');
        return false;
    });
    $('.gp').on('click', function() {
        url = 'https://plus.google.com/share?url=' + encodeURIComponent('http://djnd.si:3000/cf');
        window.open(url, '_blank');
